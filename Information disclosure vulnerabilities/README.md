...
Information Disclosure có thể xảy ra theo hai cách:
...
Bắt request xem 1 sản phẩm rồi gửi đến Repeater và sửa lại tham số `productId` với mục đích để báo lỗi.
...
Truy cập vào file `robots.txt` lấy được endpoint `/backup`, rồi truy cập vào trang backup.
